...
class memory:
    ...
    def save(self,location):
        np.save(location,(self.frames,self.actions,self.rewards,self.dones,self.pointer,self.occupied),allow_pickle=True)

    def load(self,location):
        self.frames,self.actions,self.rewards,self.dones,self.pointer,self.occupied = np.load(location,allow_pickle=True)
